...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class=\"prev\"><a href='".str_replace("{page}",$prepagenum,$tnamerule)."'></a></li>\r\n";
            $indexpage="";
        }
        else
        {
        ...
        {
            $nextpage.="<li class=\"next\"><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'></a></li>\r\n";
            $endpage="";
        }
        else
        {
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<li class=\"pagecur\"><a href=\"javascript:void(0);\">$j</a></li>\r\n";
            }
            else
            {
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class=\"prev\"><a href='".$purl."PageNo=$prepagenum'></a></li>\r\n";
            $indexpage="";
        }
        else
        {
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li class=\"next\"><a href='".$purl."PageNo=$nextpagenum'></a></li>\r\n";
            $endpage="";
        }
        else
        {
